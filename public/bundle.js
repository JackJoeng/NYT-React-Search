		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'jumbotron', style: { 'backgroundImage': 'url(./assets/images/logo.jpg)', 'backgroundRepeat': 'no-repeat', 'backgroundPosition': 'center', 'backgroundSize': '100% 100%', 'backgroundAttachment': 'fixed' } },
						React.createElement(
							'h2',
						...
						React.createElement(
							...
							'Search for and save articles of your interest!'
						)
					)
				),
				React.createElement(
